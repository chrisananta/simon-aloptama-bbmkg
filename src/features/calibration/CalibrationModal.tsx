  ...
  return (
    <div className="fixed inset-0 z-[2000] flex items-center justify-center bg-slate-900/60 backdrop-blur-xs p-4 overflow-y-auto animate-fade-in">
      <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-lg overflow-hidden my-6 flex flex-col">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="font-heading text-lg font-bold">Input Data Kalibrasi INSKAL</h3>
        ...
        {isSubmitted ? (
          <div className="p-8 text-center space-y-3 bg-purple-50">
            <div className="w-12 h-12 bg-purple-100 text-purple-600 rounded-full flex items-center justify-center mx-auto border border-purple-300">
              <Check size={24} />
            </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-5 space-y-4">
            <div className="space-y-1.5">
              <label className="block text-xs font-bold text-slate-800 flex items-center gap-1.5">
                <Wrench size={14} className="text-[#0052CC]" />
            ...
            {selectedDevice && (
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 text-xs space-y-1">
                <div className="flex justify-between text-slate-700">
                  ...
                  <span className="font-bold text-slate-900">{selectedDevice.uptStation}</span>
                </div>
                <div className="flex justify-between text-slate-700">
              ...
              <div className="space-y-1">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <button
                    ...
                    className={`py-1.5 px-2 rounded-lg text-xs font-bold transition-all border flex items-center justify-center gap-1 cursor-pointer ${
                      watchStatus === 'VALID'
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3.5 py-2.5 text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#0052CC] focus:bg-white"
              />
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-bold text-slate-800 flex items-center gap-1.5">
                <FileText size={14} className="text-[#0052CC]" />
              ...
              <textarea
                ...
                className="w-full bg-slate-50 border border-slate-300 rounded-xl p-3 text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#0052CC] focus:bg-white"
              />
            </div>
            ...
            <div className="pt-3 flex items-center justify-end gap-2 border-t border-slate-200">
              ...
              <button
                type="submit"
                className="px-5 py-2.5 rounded-xl text-xs font-bold bg-purple-700 hover:bg-purple-800 text-white shadow-md transition-all flex items-center gap-2 cursor-pointer"
              >
                <Plus size={15} />
                Tambah ke Repository Kalibrasi
              </button>
            </div>
          </form>
        )}
